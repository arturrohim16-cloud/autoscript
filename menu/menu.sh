...
echo -e "${CYAN}│${NC}  ${YELLOW}3.)☞${NC} ${WHITE}XRAY TROJAN${NC}         ${YELLOW}9.)☞${NC} ${WHITE}MENU SYSTEM${NC}      ${CYAN}│${NC}"
echo -e "${CYAN}│${NC}  ${YELLOW}4.)☞${NC} ${WHITE}XRAY VLESS${NC}         ${YELLOW}10.)☞${NC} ${WHITE}CEK RUNNING${NC}      ${CYAN}│${NC}"
echo -e "${CYAN}│${NC}  ${YELLOW}5.)☞${NC} ${WHITE}MENU SOUCKES${NC}       ${YELLOW}11.)☞${NC} ${WHITE}CLEAR RM${NC}         ${CYAN}│${NC}"
echo -e "${CYAN}│${NC}  ${YELLOW}6.)☞${NC} ${WHITE}ISTL UDP    ${NC}        ${YELLOW}x.)☞${NC} ${WHITE}EXIT${NC}             ${CYAN}│${NC}"
echo -e "${CYAN}└─────────────────────────────────────────────────┘${NC}"
# Footer
echo -e " ${CYAN}---------- t.me/caliphdev / @AjiStore ----------${NC}"
echo -e ""
read -p " $Select From option [1-11 or x] :"  opt
echo -e   ""
case $opt in
1) clear ; m-sshovpn ;;
2) clear ; m-vmess ;;
