...
echo -e "${CYAN}│${NC} ${YELLOW}CITY           ${NC}: ${WHITE}$CITY $LOC${NC}"
...
echo -e "${CYAN}│${NC} ${GREEN}DOWNLOAD       ${NC}: ${WHITE}$dtoday${NC}    printf "${CYAN}┃${NC} ${PURPLE}SSH${NC}   ${WHITE}${WB}[${GB}${ssh}${WB}]${NC}"
echo -e "${CYAN}│${NC} ${GREEN}UPLOAD         ${NC}: ${WHITE}$utoday${NC}    printf "${CYAN}┃${NC} ${PURPLE}VMESS${NC} ${WHITE}${WB}[${GB}${vmess}${WB}]${NC}"
echo -e "${CYAN}│${NC} ${GREEN}TOTAL TRAFFIC  ${NC}: ${WHITE}$ttoday${NC}   printf "${CYAN}┃${NC} ${PURPLE}VLESS${NC} ${WHITE}${WB}[${GB}${vless}${WB}]${NC}"
echo -e "${CYAN}└─────────────────────────────────────────────────┘${NC}"
...
echo -e "${CYAN}┃${NC}  ${YELLOW}4.)☞${NC} ${WHITE}MENU VLESS${NC}         ${YELLOW}11.)☞${NC} ${WHITE}CEK RUNNING${NC}      ${CYAN}┃${NC}"
